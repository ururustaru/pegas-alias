export const FORUMS_STUB = [
  {
    ...
    description:
      'Обсуждаем самые распространённые практики объяснения и отгадывания',
  ...
  },
  {
    ...
    description:
      'Как можно залутаться и нормально побегать пострелять ? Это ж стрелялка ?',
  ...
  },
  {
    ...
    description:
      'Блин, они всегда выигрывают. Может где-то в правилах прописать ?',
