...
export function RoundBoard() {
  ...
  return (
    <form className="round-board">
      ...
      <p className="round-board__summary">Настольные монстры заработали 3 очка</p>
